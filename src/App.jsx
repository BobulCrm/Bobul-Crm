...
const CATEGORIES = [
  { group:"💻 Tecnología", items:[
    ...
    {id:"nocode",label:"Automatización e integraciones (APIs / no-code)",icon:"⚙️",stages:["Lead","Diagnóstico","Propuesta","Aprobación",L.settings,"Pruebas","Entrega","Soporte","Cobro"]},
  ...
  { group:"📣 Marketing Digital", items:[
    {id:"seo",label:"SEO / SEM / Google Ads",icon:"🔍",stages:["Lead","Auditoría","Propuesta","Contrato",L.settings,"Implementación","Optimización","Reporte","Renovación"]},
    ...
    {id:"email",label:"Email marketing y automation",icon:"📧",stages:["Lead","Brief","Propuesta",L.settings,"Diseño de secuencias","Pruebas","Lanzamiento","Reporte","Cobro"]},
...
const I18N = {
  es: {
    ...
    // Client form
    newClientTitle:L.newClientTitle, editClientTitle:L.editClientTitle, registerContact:"Registrar contacto",
    ...
    cancel:"Cancelar", registerBtn:L.registerBtn, saveBtn:L.saveBtn,
    // Client detail tabs
    ...
    // Calendar
    today:"Hoy", newEvent:"+ Evento", noUpcoming:L.noUpcoming,
    ...
    eventNotes:"Notas", addEvent:"Agregar", editEvent:L.editEvent, newEventTitle:L.newEventTitle,
    deleteEvent:"Eliminar",
    // Settings
    settings:L.settings, customize:L.customize,
    profileTab:"👤 Perfil", stagesTab:"📋 Etapas", categoryTab:"🏷️ Categoría", appearanceTab:"🎨 Apariencia", languageTab:"🌐 Idioma",
    yourName:L.yourName, businessName:L.businessName, saveChanges:L.saveBtn,
    ...
    // Auth
    signIn:L.signIn, signUp:L.signUp, forgotPassword:"¿Olvidaste tu contraseña?",
    email2:L.email2, password:L.password, rememberEmail:L.rememberEmail,
    stayConnected:L.stayConnected, sendResetLink:L.sendResetLink,
    ...
    // Misc
    noClients:L.noClients, loading:"Cargando Bobul...", saving:"Guardando...",
  ...
  return(<div style={{minHeight:"100vh",background:T.bg,fontFamily:"'Jost',sans-serif",color:T.text,display:"flex",flexDirection:"column"}}>
    ...
    <div style={{background:T.surface,borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:100}}>
      ...
      <div style={{display:"flex",borderTop:`1px solid ${T.border}`,overflowX:"auto"}}>
        {[["kanban",L.kanban],["list",L.list],["stats",L.stats],["tasks",`Tareas${pendingTasks>0?" ("+pendingTasks+")":""}`],["calendar",L.calendar]].map(([v,label])=>(
    ...
    <div style={{background:T.surface,padding:"9px 18px",display:"flex",gap:28,alignItems:"center",flexWrap:"wrap"}}>
      {[
        ...
        {label:"Tareas pendientes",value:pendingTasks,c:pendingTasks>0?T.red:T.textMuted},
  ...
  if(user===undefined||loadingConfig) return(
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Cormorant Garamond',serif"}}>
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:14,color:T.textMuted,letterSpacing:2}}>{L.loading}</div>
      </div>
    </div>
  );
