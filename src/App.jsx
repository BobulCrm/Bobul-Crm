      ...
      <div style={{padding:"0 12px",display:"flex",alignItems:"center",height:50,gap:8}}>
        ...
        <div style={{flex:1,position:"relative",minWidth:0}}>
          ...
          <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Buscar..."
            style={{...inputS,padding:"9px 10px 9px 28px",fontSize:14,width:"100%",minWidth:0}}/>
          {search&&<span onClick={()=>setSearch("")} style={{position:"absolute",right:8,top:"50%",transform:"translateY(-50%)",color:T.textMuted,fontSize:14,cursor:"pointer",lineHeight:1}}>✕</span>}
        </div>
