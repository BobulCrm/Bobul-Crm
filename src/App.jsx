    ...
    <div style={{background:T.surface,borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:100}}>
      ...
      <div style={{padding:"0 12px",display:"flex",alignItems:"center",height:50,gap:8}}>
        <div style={{display:"flex",alignItems:"center",gap:7,flexShrink:0,minWidth:0}}>
          ...
          <div style={{minWidth:0,position:"relative",cursor:"pointer"}} onClick={e=>{e.stopPropagation();setShowCategoryTip(v=>!v);}}>
            ...
            {showCategoryTip&&(
              <div onClick={e=>e.stopPropagation()} style={{position:"absolute",top:"calc(100% + 8px)",left:0,background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,padding:"10px 14px",zIndex:200,boxShadow:"0 4px 20px rgba(0,0,0,.12)",minWidth:180,animation:"fadeUp .15s"}}>
                <div style={{fontSize:9,color:T.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>Negocio</div>
                <div style={{fontSize:13,fontWeight:600,color:T.text,fontFamily:"Cormorant Garamond,serif",marginBottom:8}}>{company||name}</div>
                <div style={{fontSize:9,color:T.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>Categoría</div>
                <div style={{fontSize:12,color:T.text}}>{profession?.icon} {profession?.label}</div>
              </div>
            )}
          </div>
        </div>
