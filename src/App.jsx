          ...
          <div onClick={e=>e.stopPropagation()} style={{
            ...
            <div style={{display:"flex",gap:8}}>
              ...
              <button onClick={handleSend}
                style={{flex:2,background:opened.channel==="whatsapp"?"#25D366":T.grad,color:"#FFFFFF",padding:"11px",borderRadius:2,fontSize:11,fontWeight:700,letterSpacing:2,textTransform:"uppercase",border:"none",cursor:"pointer"}}>
    ...
    <div>
      ...
      <div style={{display:"flex",gap:8}}>
        ...
        <button onClick={()=>onSave(draft)} disabled={disabled}
          style={{flex:2,background:T.grad,color:"#FFFFFF",padding:"11px",borderRadius:2,fontSize:11,fontWeight:700,letterSpacing:2,textTransform:"uppercase",border:"none",cursor:disabled?"not-allowed":"pointer",opacity:disabled?.5:1}}>
          ◈ Guardar
        </button>
      </div>
    </div>
        ...
        {!editing && (
          <>
            <button onClick={()=>setEditing(blank)}
              style={{width:"100%",background:T.grad,color:"#FFFFFF",padding:"10px",borderRadius:2,fontSize:11,fontWeight:700,letterSpacing:2,textTransform:"uppercase",border:"none",cursor:"pointer",marginBottom:14}}>
              + Nueva plantilla
            </button>
