                ...
                return(
                  ...
                  onMouseLeave={e=>{if(day)e.currentTarget.style.background=isToday(day)?`${T.gold}15`:T.surface;}}>
                    ...
                    {dayClients.slice(0,2).map(cl=>(
                      <div key={cl.id} style={{fontSize:9,background:`${T.red}15`,color:T.red,padding:"2px 4px",borderRadius:1,marginBottom:1,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis",maxWidth:"100%"}}>
                        📌 {cl.name}
                      </div>
                    ))}
          ...
          <div style={{padding:"20px 22px"}}>
            ...
            <div style={{marginBottom:20}}>
              {[
                ...
                {label:"Próximo cobro",value:"Revisa tu email de Stripe",color:T.text},
            ...
            <div style={{borderTop:`1px solid ${T.border}`,paddingTop:16}}>
              <div style={{fontSize:11,color:T.textMuted,marginBottom:12,lineHeight:1.6}}>
                Si cancelas, seguirás teniendo acceso hasta el final del período pagado. Después tu cuenta pasará al plan gratuito automáticamente.
              </div>
              <button className="pBtn" onClick={()=>{
