          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:12}}>
            <div style={{minWidth:0,overflow:"hidden"}}>
              ...
              <input type="date" value={eventForm.date} onChange={e=>setEventForm(ef=>({...ef,date:e.target.value}))}
                style={{width:"100%",maxWidth:"100%",display:"block",background:T.card,border:`1px solid ${T.border}`,borderRadius:2,padding:"9px 8px",color:T.text,fontSize:12,fontFamily:"'Jost',sans-serif"}}/>
            </div>
            <div style={{minWidth:0,overflow:"hidden"}}>
