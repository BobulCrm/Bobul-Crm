          ...
          <div onClick={e=>e.stopPropagation()} style={{
            ...
            <div style={{display:"flex",gap:8}}>
              ...
              <button onClick={handleSend}
                style={{flex:2,background:opened.channel==="whatsapp"?"#25D366":T.grad,color:opened.channel==="whatsapp"?"#FFFFFF":"#0C0A08",padding:"11px",borderRadius:2,fontSize:11,fontWeight:700,letterSpacing:2,textTransform:"uppercase",border:"none",cursor:"pointer"}}>
