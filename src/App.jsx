            ...
            {settTab==="automation"&&(
              <div>
                ...
                <div style={{marginBottom:18,opacity:followUpEnabled?1:.5,transition:"opacity .2s",pointerEvents:followUpEnabled?"auto":"none"}}>
                  <div style={{fontSize:9,color:T.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:5,fontWeight:600}}>Días sin movimiento antes de avisar</div>
                  <div style={{display:"flex",alignItems:"center",gap:10}}>
                    <input type="number" min="1" max="365" value={followUpDays}
                      ...
                      style={{width:90,background:T.card,border:`1px solid ${T.border}`,borderRadius:2,padding:"10px 13px",color:T.text,fontSize:14,fontFamily:"Jost,sans-serif",textAlign:"center"}}/>
                    <span style={{fontSize:12,color:T.textMuted}}>días</span>
                  </div>
                  <div style={{fontSize:10,color:T.textDim,marginTop:6,lineHeight:1.5}}>Recomendado entre 5 y 14 días. Se mide desde el último contacto registrado.</div>
                </div>
