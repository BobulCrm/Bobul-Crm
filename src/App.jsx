...
// ─── CRM MAIN ─────────────────────────────────────────────────────────────────
function CRM({config,user,supabase,onReset,onSignOut}){
...
export default function App(){
  ...
  // Full CRM
  return(<><style>{css}</style><CRM config={config} user={user} supabase={sb} onReset={()=>setConfig(null)} onSignOut={handleSignOut}/></>);
}
