...
const CATEGORIES = [
  { group:"💻 Tecnología", items:[
    ...
    {id:"mobile",label:"Desarrollo de apps móviles",icon:"📱",stages:["Lead","Requerimientos",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Diseño UI","Desarrollo","Testing","Publicación","Cobro"]},
    ...
    {id:"nocode",label:"Automatización e integraciones (APIs / no-code)",icon:"⚙️",stages:["Lead","Diagnóstico",lang==="en"?"Proposal":"Propuesta","Aprobación","Configuración","Pruebas","Entrega","Soporte","Cobro"]},
    {id:"datascience",label:"Data Science / Análisis de datos",icon:"📊",stages:["Lead","Definición del problema",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Recolección","Análisis","Modelo","Entrega","Facturado"]},
  ]},
  ...
  { group:"📣 Marketing Digital", items:[
    {id:"seo",label:"SEO / SEM / Google Ads",icon:"🔍",stages:["Lead","Auditoría",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Configuración","Implementación","Optimización","Reporte","Renovación"]},
    {id:"socialmedia",label:"Gestión de redes sociales",icon:"📲",stages:["Lead","Diagnóstico",lang==="en"?"Proposal":"Propuesta","Onboarding","Calendario aprobado","Publicación activa","Reporte mensual","Renovación"]},
    {id:"email",label:"Email marketing y automation",icon:"📧",stages:["Lead","Brief",lang==="en"?"Proposal":"Propuesta","Configuración","Diseño de secuencias","Pruebas","Lanzamiento","Reporte","Cobro"]},
    {id:"content",label:"Estrategia de contenidos",icon:"📝",stages:["Lead","Diagnóstico",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Investigación","Estrategia","Implementación","Reporte","Renovación"]},
    {id:"influencer",label:"Influencer marketing",icon:"⭐",stages:["Contacto marca","Brief campaña","Negociación",lang==="en"?"Contract":"Contrato","Creación de contenido","Revisión","Publicación","Métricas","Cobro"]},
  ]},
  ...
  { group:"📊 Negocios & Administración", items:[
    {id:"va",label:"Asistente virtual / Soporte administrativo",icon:"🗂️",stages:["Lead","Entrevista",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Onboarding","Activo","Evaluación mensual","Renovación"]},
    {id:"accounting",label:"Contabilidad y finanzas",icon:"💰",stages:["Contacto","Diagnóstico",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Recopilación de info","Procesamiento","Reporte","Presentación","Cobro"]},
    {id:"hr",label:"Recursos humanos",icon:"👥",stages:["Lead","Brief",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Relevamiento","Implementación","Seguimiento","Entrega","Cobro"]},
    {id:"research",label:"Investigación de mercados",icon:"🔬",stages:["Lead","Brief",lang==="en"?"Proposal":"Propuesta","Aprobación","Diseño metodológico","Recolección","Análisis","Informe","Cobro"]},
    {id:"consulting",label:"Gestión de proyectos y consultoría",icon:"🧠",stages:["Lead","Discovery call",lang==="en"?"Proposal":"Propuesta","Contrato firmado","Diagnóstico","Implementación","Seguimiento","Cierre","Cobro"]},
  ]},
  { group:"⚖️ Legal", items:[
    {id:"legal",label:"Legal / Asesoría jurídica independiente",icon:"⚖️",stages:["Consulta inicial","Evaluación del caso","Propuesta de honorarios",lang==="en"?"Contract":"Contrato","Investigación legal","Elaboración de documentos","Revisión","Presentación","Cobro"]},
  ]},
  ...
  { group:"🎓 Educación & Formación", items:[
    {id:"languages",label:"Clases de idiomas",icon:"🗣️",stages:["Lead","Evaluación de nivel",lang==="en"?"Proposal":"Propuesta","Pago","Clases activas","Seguimiento","Evaluación","Renovación"]},
    {id:"tutoring",label:"Tutoría académica online",icon:"📚",stages:["Lead","Diagnóstico",lang==="en"?"Proposal":"Propuesta","Pago","Sesiones activas","Seguimiento de progreso","Evaluación final","Renovación"]},
    ...
    {id:"elearning",label:"Diseño instruccional / E-learning",icon:"💡",stages:["Lead","Análisis de necesidades",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Diseño instruccional","Desarrollo de contenido","Revisión","Publicación","Cobro"]},
  ]},
  { group:"🏥 Salud & Bienestar", items:[
    {id:"psychology",label:"Psicología y coaching online",icon:"🧘",stages:["Consulta inicial","Evaluación","Propuesta de plan",lang==="en"?"Contract":"Contrato","Sesiones activas","Seguimiento","Evaluación de progreso","Cierre / Renovación"]},
    ...
    {id:"fitness",label:"Entrenador personal / Fitness online",icon:"💪",stages:["Lead","Evaluación física",lang==="en"?"Proposal":"Propuesta","Pago","Plan de entrenamiento","Semana activa","Control de progreso","Renovación"]},
  ...
  { group:"🏗️ Técnico & Construcción", items:[
    ...
    {id:"engineering",label:"Ingeniería y consultoría técnica",icon:"⚙️",stages:["Lead","Diagnóstico técnico",lang==="en"?"Proposal":"Propuesta",lang==="en"?"Contract":"Contrato","Levantamiento","Análisis","Informe técnico","Presentación","Cobro"]},
  ]},
];
...
const THEMES = {
  ivory: {
    name:{es:"☀️ Marfil Dorado",en:"☀️ Golden Ivory"}, id:"ivory",
  ...
  night: {
    name:{es:"🌙 Noche Elegante",en:"🌙 Elegant Night"}, id:"night",
  ...
  forest: {
    name:{es:"🌿 Bosque",en:"🌿 Forest"}, id:"forest",
  ...
  ocean: {
    name:{es:"🌊 Océano",en:"🌊 Ocean"}, id:"ocean",
  ...
  rose: {
    name:{es:"🌸 Rosa Editorial",en:"🌸 Editorial Rose"}, id:"rose",
  ...
  carbon: {
    name:{es:"🖤 Carbón",en:"🖤 Carbon"}, id:"carbon",
...
const I18N = {
  es: {
    ...
    // Top bar
    searchPlaceholder:"Buscar...", allStages:"Todas", newClient:L.newClient,
    // Stats bar
    ...
    name:L.name, company:L.company, email:L.email, phone:L.phone, address:L.address,
    commercialInfo:"Información comercial", projectValue:L.projectValue, currency:L.currency,
    stage:L.stage, leadSource:L.leadSource, expectedClose:L.expectedClose, lastContact:L.lastContact,
    tags:L.tags, projectNotes:L.projectNotes, notesPlaceholder:"Detalles, acuerdos, contexto del proyecto...",
    privacyConsent:"Consentimiento de privacidad", privacyText:"{lang==="en"?"The client has given consent for their data to be processed for commercial purposes.":"El cliente ha dado su consentimiento para que sus datos sean tratados con fines comerciales, conforme al Aviso de Privacidad."} para que sus datos sean tratados con fines comerciales, conforme al Aviso de Privacidad.",
    cancel:"Cancelar", registerBtn:"Registrar cliente", saveBtn:L.saveChanges,
    // Client detail tabs
    info:L.info, activity:"Actividad", taskTab:"Tareas", files:"Archivos",
    // Activity
    quickSend:"Enviar mensaje rapido", logActivity:L.logActivity, activityType:L.activityType,
    activityNote:L.activityNote, activityDate:L.eventDate, addActivity:L.addActivity,
    noActivity:L.noActivity, history:lang==="en"?"History":"Historial",
    // Tasks
    newTask:L.newTask, taskTitle:L.taskTitle, priority:L.priority, dueDate:L.dueDate,
    addTask:L.addTask, noTasks:L.noTasks,
    // Files
    uploadFile:L.uploadFile, fileCategory:L.fileCategory, noFiles:L.noFiles,
    download:L.download, preview:"Ver",
    // Calendar
    today:"Hoy", newEvent:lang==="en"?"+ Event":"+ Evento", noUpcoming:"Sin eventos próximos — toca un día para agregar uno",
    upcomingEvents:"Próximos eventos", eventTitle:L.eventTitle, eventDate:L.eventDate, eventTime:L.eventTime,
    eventType:L.eventType, eventClient:L.eventClient, noClientAssoc:L.noClientAssoc,
    eventNotes:L.eventNotes, addEvent:L.addEvent, editEvent:"Editar evento", newEventTitle:"Nuevo evento",
    deleteEvent:L.deleteEvent,
    // Settings
    ...
    yourName:"Tu nombre", businessName:"Nombre de tu negocio", saveChanges:L.saveChanges,
    stagesDesc:"Edita los nombres, reordena arrastrando o agrega nuevas etapas.",
    newStage:"+ Nueva etapa...", saveStages:L.saveStages,
    ...
    selectSource:"{lang==="en"?"Select...":"Seleccionar..."}", days:"d", free2:"Gratis",
  },
  en: {
    // Navigation
    ...
    name:"Name *", company:"Company", email:L.email, phone:"Phone", address:"Address (optional)",
    ...
    // Client detail tabs
    info:L.info, activity:"Activity", taskTab:"Tasks", files:"Files",
    // Activity
...
const LEAD_SOURCES_I18N = {
  es: ["Referido","Redes sociales","Sitio web","Google Ads",L.email,"LinkedIn","Llamada en frío","Evento / Feria",lang==="en"?"Other":"Otro"],
  en: ["Referral","Social media","Website","Google Ads",L.email,"LinkedIn","Cold call","Event / Trade show","Other"],
};
...
const EVENT_TYPES_I18N = {
  es: ["Llamada","Reunión","Seguimiento",lang==="en"?"Proposal":"Propuesta","Pago",lang==="en"?"Other":"Otro"],
...
const LEAD_SOURCES = ["Referido","Redes sociales","Sitio web","Google Ads",L.email,"LinkedIn","Llamada en frío","Evento / Feria",lang==="en"?"Other":"Otro"];
...
// ---  ---CRM MAIN -----------------------------------------------------------------
function CRM({config,user,supabase,plan,themeId,onThemeChange,lang,onLangChange,onUpgrade,onReset,onSignOut}){
  const L = I18N[lang]||I18N.es;
  const LEAD_SOURCES_L = LEAD_SOURCES_I18N[lang]||LEAD_SOURCES_I18N.es;
  const ACTIVITY_TYPES_L = ACTIVITY_TYPES_I18N[lang]||ACTIVITY_TYPES_I18N.es;
  const TASK_PRIORITIES_L = TASK_PRIORITIES_I18N[lang]||TASK_PRIORITIES_I18N.es;
  const TAGS_OPTIONS_L = TAGS_OPTIONS_I18N[lang]||TAGS_OPTIONS_I18N.es;
  const EVENT_TYPES_L = EVENT_TYPES_I18N[lang]||EVENT_TYPES_I18N.es;
  const WEEKDAYS_L = WEEKDAYS_I18N[lang]||WEEKDAYS_I18N.es;
  ...
  const exportCSV=()=>{
    const headers=[lang==="en"?"Name":"Nombre",L.company,L.email,L.phone,lang==="en"?"Value":"Valor",L.stage,"Fuente","Tags",L.eventNotes,L.lastContact,"Creado"];
  ...
  return(<div style={{minHeight:"100vh",background:T.bg,fontFamily:"'Jost',sans-serif",color:T.text,display:"flex",flexDirection:"column"}}>
    ...
    <div style={{background:T.surface,borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:100}}>
      ...
      <div style={{padding:"0 12px",display:"flex",alignItems:"center",height:50,gap:8}}>
        ...
        <select value={filterStage} onChange={e=>setFilterStage(e.target.value)} style={{background:T.card,border:`1px solid ${T.border}`,color:filterStage==="all"?T.textMuted:T.gold,borderRadius:2,padding:"6px 8px",fontSize:11,fontFamily:"'Jost',sans-serif",flexShrink:0,maxWidth:110}}>
          <option value="all">{L.allStages}</option>
        ...
        <div style={{position:"relative",flexShrink:0}}>
          ...
          {showMobileMenu&&(<div style={{position:"absolute",top:"110%",right:0,background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,boxShadow:"0 8px 24px rgba(0,0,0,.15)",zIndex:200,minWidth:170,padding:6}} onClick={e=>e.stopPropagation()}>
            <button className="pBtn" onClick={()=>{exportCSV();setShowMobileMenu(false);}} style={{display:"block",width:"100%",textAlign:"left",padding:"9px 12px",fontSize:12,color:T.text,background:"transparent",borderRadius:2}}>{L.exportCSV}</button>
            <button className="pBtn" onClick={()=>{setShowSettings(true);setShowMobileMenu(false);}} style={{display:"block",width:"100%",textAlign:"left",padding:"9px 12px",fontSize:12,color:T.text,background:"transparent",borderRadius:2}}>{L.configuration}</button>
            {installPromptCRM&&!installedCRM&&<button className="pBtn" onClick={()=>{handleInstallCRM();setShowMobileMenu(false);}} style={{display:"block",width:"100%",textAlign:"left",padding:"9px 12px",fontSize:12,color:T.gold,background:"transparent",borderRadius:2}}>{L.installApp}</button>}
            <div style={{height:1,background:T.border,margin:"4px 0"}}/>
            <button className="pBtn" onClick={()=>onSignOut()} style={{display:"block",width:"100%",textAlign:"left",padding:"9px 12px",fontSize:12,color:T.red,background:"transparent",borderRadius:2}}>{L.signOut}</button>
          </div>)}
        </div>
      </div>
      ...
      <div style={{display:"flex",borderTop:`1px solid ${T.border}`,overflowX:"auto"}}>
        {[["kanban",L.kanban],["list",L.list],["stats",L.stats],["tasks",`${L.tasks}${pendingTasks>0?" ("+pendingTasks+")":""}`],["calendar",L.calendar]].map(([v,label])=>(
    ...
    <div style={{background:T.surface,padding:"9px 18px",display:"flex",gap:28,alignItems:"center",flexWrap:"wrap"}}>
      {[
        {label:L.pipeline,value:dbLoading?"...":fmt(pipeline),c:T.gold},
        {label:L.won,value:fmt(closedV),c:T.green},
        {label:L.activeClients,value:clients.filter(c=>c.stage!==STAGES[STAGES.length-1]).length,c:T.text},
        {label:L.totalClients,value:clients.length,c:T.textMuted},
        {label:L.pendingTasks,value:pendingTasks,c:pendingTasks>0?T.red:T.textMuted},
      ].map(s=>(<div key={s.label}>
        <div style={{fontSize:9,color:T.textMuted,textTransform:"uppercase",letterSpacing:1.5,marginBottom:2}}>{s.label}</div>
        <div style={{fontSize:19,fontWeight:600,color:s.c,fontFamily:"'Cormorant Garamond',serif"}}>{s.value}</div>
      </div>))}
      <div style={{marginLeft:"auto",display:"flex",alignItems:"center",gap:10}}>
        <div style={{fontSize:10,color:T.textMuted}}>
          Plan: <span style={{color:plan==="free"?T.textMuted:T.gold,fontWeight:600,textTransform:"uppercase"}}>{plan==="free"?"Gratis":plan==="pro"?"Pro":"Equipo"}</span>
        </div>
        {plan==="free"&&(
          <button className="pBtn" onClick={onUpgrade} style={{background:T.grad,color:"#0C0A08",padding:"5px 12px",borderRadius:2,fontSize:10,fontWeight:700,letterSpacing:1,textTransform:"uppercase"}}>
            ⭐ Mejorar plan
          </button>
        )}
      </div>
    ...
    <div style={{flex:1,overflow:"auto",overflowX:"hidden",padding:18,maxWidth:"100vw"}}>
        ...
        <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,overflow:"hidden"}}>
          <table style={{width:"100%",borderCollapse:"collapse"}}>
            <thead><tr style={{borderBottom:`1px solid ${T.border}`}}>
              {["Cliente",L.company,lang==="en"?"Value":"Valor",L.stage,"Fuente","Tags","Últ. contacto",""].map(h=>(
      ...
      {view==="stats"&&(<div style={{maxWidth:800,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
        <div style={{gridColumn:"1/-1",background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,padding:20}}>
          <Label>{lang==="en"?"Pipeline by stage":"Pipeline por etapa"}</Label>
          {STAGES.map(stage=>{
        ...
        <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,padding:20}}>
          ...
          {LEAD_SOURCES_L.map(src=>{const n=clients.filter(c=>c.source===src).length;return n>0?(<div key={src} style={{display:"flex",justifyContent:"space-between",padding:"7px 0",borderBottom:`1px solid ${T.border}`}}>
          ...
          {clients.filter(c=>c.source).length===0&&<div style={{color:T.textDim,fontSize:12}}>{lang==="en"?"No source data yet":"Sin datos de fuente aún"}</div>}
        </div>
      </div>)}
      ...
      {view==="tasks"&&(<div style={{maxWidth:700,margin:"0 auto"}}>
        ...
        {pendingTasks===0&&<div style={{textAlign:"center",padding:52,color:T.textDim}}><div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:28,marginBottom:8}}>✓</div>{lang==="en"?"No pending tasks":"Sin tareas pendientes"}</div>}
      </div>)}
    </div>
    ...
    {selected&&(<div style={{position:"fixed",inset:0,background:"rgba(44,36,32,.5)",zIndex:200,display:"flex",justifyContent:"flex-end",animation:"fadeIn .2s"}} onClick={()=>setSelected(null)}>
      <div style={{width:400,background:T.surface,borderLeft:`1px solid ${T.border}`,height:"100%",display:"flex",flexDirection:"column",animation:"slideR .25s"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{display:"flex",borderBottom:`1px solid ${T.border}`,flexShrink:0}}>
          {[["info",L.info],["activity",L.activity],["tasks",L.taskTab],["files",L.files]].map(([id,label])=>(<button key={id} className="tabBtn" onClick={()=>setDetailTab(id)} style={{flex:1,padding:"10px",fontSize:10,letterSpacing:1,textTransform:"uppercase",background:"transparent",color:detailTab===id?T.gold:T.textMuted,borderBottom:detailTab===id?`1px solid ${T.gold}`:"1px solid transparent",marginBottom:-1}}>{label}{id==="tasks"&&(selected.tasks||[]).filter(t=>!t.done).length>0?` (${(selected.tasks||[]).filter(t=>!t.done).length})`:""}{id==="files"&&(selected.files||[]).length>0?` (${(selected.files||[]).length})`:""}</button>))}
        </div>
        ...
        <div style={{flex:1,overflowY:"auto",padding:"16px 20px"}}>
          ...
          {detailTab==="info"&&(<div>
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:16}}>
              {[
                {label:L.email,value:selected.email},
                {label:L.phone,value:selected.phone},
                {label:L.company,value:selected.company},
                {label:"Dirección",value:selected.address},
                {label:L.leadSource,value:selected.source},
                {label:L.expectedClose,value:fmtDate(selected.expectedClose)},
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8,marginBottom:8}}>
              ...
              <div>
                ...
                <select value={taskPriority} onChange={e=>setTaskPriority(e.target.value)} style={inputS}>
                  {TASK_PRIORITIES_L.map(p=><option key={p}>{p}</option>)}
                </select>
              </div>
            </div>
            ...
            <div style={{marginTop:14}}>
              ...
              {(selected.files||[]).length===0&&(
                <div style={{textAlign:"center",padding:"28px 0",color:T.textDim}}>
                  ...
                  <div style={{fontSize:12}}>{lang==="en"?"No files yet":"Sin archivos aún"}</div>
                </div>
              )}
                      ...
                      <div key={file.id} style={{display:"flex",alignItems:"center",gap:10,padding:"9px 10px",background:T.card,border:`1px solid ${T.border}`,borderRadius:2,marginBottom:5}}>
                        ...
                        <div style={{display:"flex",gap:5,flexShrink:0}}>
                          {(file.url||file.dataUrl)&&(
                            <button className="pBtn" onClick={()=>downloadFile(file)} title=L.download
                          ...
                          {(file.url||file.dataUrl)&&file.type&&file.type.includes("image")&&(
                            <button className="pBtn" onClick={()=>window.open(file.url||file.dataUrl,"_blank")} title={lang==="en"?"Preview":"Ver"}
                          ...
                          <button className="pBtn" onClick={()=>deleteFile(file.id)} title=L.deleteEvent
    ...
    {showForm&&(<div style={{position:"fixed",inset:0,background:"rgba(44,36,32,.6)",zIndex:300,display:"flex",alignItems:"flex-start",justifyContent:"center",animation:"fadeIn .2s",padding:16,overflowY:"auto",overflowX:"hidden"}} onClick={()=>setShowForm(false)}>
      <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,width:"100%",maxWidth:540,maxHeight:"92vh",display:"flex",flexDirection:"column",overflowX:"hidden",animation:"fadeUp .25s"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{padding:"20px 24px",borderBottom:`1px solid ${T.border}`,flexShrink:0}}>
          <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:22,fontWeight:600,color:T.text}}>{editing?L.editClientTitle:L.newClientTitle}</div>
        ...
        <div style={{flex:1,overflowY:"auto",overflowX:"hidden",padding:"18px 16px",width:"100%"}}>
          ...
          <div style={{marginBottom:14,borderBottom:`1px solid ${T.border}`,paddingBottom:14}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,width:"100%",minWidth:0}}>
              <div><Label>{L.projectValue}</Label><input type="number" value={form.value} onChange={e=>setForm({...form,value:e.target.value})} placeholder="0" style={inputS}/></div>
              <div><Label>{L.currency}</Label><select value={form.currency} onChange={e=>setForm({...form,currency:e.target.value})} style={inputS}>{["MXN","USD","EUR","COP","ARS","CLP","PEN"].map(c=><option key={c}>{c}</option>)}</select></div>
              <div><Label>{L.stage}</Label><select value={form.stage} onChange={e=>setForm({...form,stage:e.target.value})} style={inputS}>{STAGES.map(s=><option key={s}>{s}</option>)}</select></div>
              <div><Label>{L.leadSource}</Label><select value={form.source} onChange={e=>setForm({...form,source:e.target.value})} style={inputS}><option value="">{lang==="en"?"Select...":"Seleccionar..."}</option>{LEAD_SOURCES_L.map(s=><option key={s}>{s}</option>)}</select></div>
              <div style={{minWidth:0,overflow:"hidden"}}><Label>{L.expectedClose}</Label><input type="date" value={form.expectedClose} onChange={e=>setForm({...form,expectedClose:e.target.value})} style={{...inputS,width:"100%",maxWidth:"100%"}}/></div>
              <div style={{minWidth:0,overflow:"hidden"}}><Label>{L.lastContact}</Label><input type="date" value={form.lastContact||today()} onChange={e=>setForm({...form,lastContact:e.target.value})} style={{...inputS,width:"100%",maxWidth:"100%"}}/></div>
            </div>
          </div>
          ...
          <div style={{marginBottom:14,borderBottom:`1px solid ${T.border}`,paddingBottom:14}}>
            ...
            <div style={{display:"flex",flexWrap:"wrap",gap:6}}>
              {TAGS_OPTIONS_L.map(tag=>{const active=(form.tags||[]).includes(tag);return(<button key={tag} className="pBtn" onClick={()=>setForm({...form,tags:active?(form.tags||[]).filter(t=>t!==tag):[...(form.tags||[]),tag]})} style={{padding:"4px 10px",borderRadius:1,fontSize:10,letterSpacing:.5,border:`1px solid ${active?T.gold:T.border}`,background:active?`${T.gold}18`:"transparent",color:active?T.gold:T.textMuted}}>{tag}</button>);})}
            </div>
          </div>

          <div style={{marginBottom:14,borderBottom:`1px solid ${T.border}`,paddingBottom:14}}>
            <Label>{L.projectNotes}</Label>
            <textarea value={form.notes} onChange={e=>setForm({...form,notes:e.target.value})} placeholder={L.notesPlaceholder} rows={3} style={{...inputS,resize:"vertical",lineHeight:1.6}}/>
          </div>
          ...
          <div style={{background:T.card,border:`1px solid ${T.border}`,borderRadius:2,padding:14,marginBottom:14}}>
            ...
            <label style={{display:"flex",alignItems:"flex-start",gap:10,cursor:"pointer"}}>
              ...
              <span style={{fontSize:11,color:T.textMuted,lineHeight:1.6}}>{lang==="en"?"The client has given consent for their data to be processed for commercial purposes.":"El cliente ha dado su consentimiento para que sus datos sean tratados con fines comerciales, conforme al Aviso de Privacidad."} para que sus datos sean tratados con fines comerciales, conforme al Aviso de Privacidad.</span>
            </label>
          </div>
        </div>

        <div style={{padding:"14px 24px",borderTop:`1px solid ${T.border}`,display:"flex",gap:10,flexShrink:0}}>
          <button className="pBtn" onClick={()=>setShowForm(false)} style={{flex:1,background:"transparent",border:`1px solid ${T.border}`,color:T.textMuted,padding:"10px",borderRadius:2,fontSize:10,letterSpacing:2,textTransform:"uppercase"}}>{L.cancel}</button>
          <button className="pBtn" onClick={save} style={{flex:2,background:T.grad,color:"#0C0A08",padding:"10px",borderRadius:2,fontSize:10,fontWeight:700,letterSpacing:2,textTransform:"uppercase",boxShadow:`0 4px 20px ${T.gold}25`}}>
            {editing?L.saveBtn:L.registerBtn}
          </button>
        </div>
      </div>
    </div>)}
      ...
      <div style={{maxWidth:900,margin:"0 auto"}}>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:16}}>
          ...
          <div style={{display:"flex",gap:8}}>
            ...
            <button className="pBtn" onClick={()=>{setEditingEvent(null);setEventForm({title:"",date:today(),time:"10:00",type:"Llamada",clientId:"",notes:""});setShowEventForm(true);}} style={{background:T.grad,color:"#fff",padding:"6px 14px",borderRadius:2,fontSize:11,fontWeight:700,letterSpacing:1,textTransform:"uppercase"}}>{lang==="en"?"+ Event":lang==="en"?"+ Event":"+ Evento"}</button>
          </div>
        </div>
              ...
              {cells.map((day,idx)=>{
                ...
                return(
                  <div key={idx} onClick={()=>{if(day){setEventForm(f=>({...f,date:dateStr}));setEditingEvent(null);setShowEventForm(true);}}} style={{
                    minHeight:80,background:day?(isToday(day)?`${T.gold}15`:T.surface):T.bg,
                  ...
                  onMouseLeave={e=>{if(day)e.currentTarget.style.background=isToday(day)?`${T.gold}15`:T.surface;}}>
                    {day&&<div style={{fontSize:11,fontWeight:isToday(day)?700:500,color:isToday(day)?T.gold:T.text,marginBottom:3,textAlign:"right"}}>{day}</div>}
                    {dayEvents.slice(0,3).map(ev=>(
                      <div key={ev.id} onClick={e=>{e.stopPropagation();setEditingEvent(ev);setEventForm({...ev});setShowEventForm(true);}} style={{fontSize:9,background:ev.type==="Llamada"?`${T.blue}20`:ev.type==="Reunión"?`${T.green}20`:ev.type==="Seguimiento"?`${T.gold}20`:`${T.textMuted}15`,color:ev.type==="Llamada"?T.blue:ev.type==="Reunión"?T.green:ev.type==="Seguimiento"?T.gold:T.textMuted,padding:"2px 4px",borderRadius:1,marginBottom:1,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis",cursor:"pointer"}}>
                        {ev.time} {ev.title}
                      </div>
                    ))}
                    {dayClients.slice(0,2).map(cl=>(
                      <div key={cl.id} style={{fontSize:9,background:`${T.red}15`,color:T.red,padding:"2px 4px",borderRadius:1,marginBottom:1,overflow:"hidden",whiteSpace:"nowrap",textOverflow:"ellipsis"}}>
                        📌 {cl.name}
                      </div>
                    ))}
        ...
        <div style={{marginTop:20,background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,padding:16}}>
          <div style={{fontSize:9,color:T.gold,letterSpacing:2,textTransform:"uppercase",marginBottom:12,fontWeight:600}}>{L.upcomingEvents}</div>
    ...
    {showEventForm&&(
      <div style={{position:"fixed",inset:0,background:"rgba(44,36,32,.6)",zIndex:300,display:"flex",alignItems:"flex-start",justifyContent:"center",padding:16,paddingTop:40,overflowY:"auto",overflowX:"hidden",animation:"fadeIn .2s"}} onClick={()=>setShowEventForm(false)}>
        <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,width:"100%",maxWidth:420,padding:20,animation:"fadeUp .25s",overflowX:"hidden"}} onClick={e=>e.stopPropagation()}>
          <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:600,color:T.text,marginBottom:4}}>{editingEvent?L.editEvent:L.newEventTitle}</div>
          <div style={{fontSize:9,color:T.gold,letterSpacing:2,textTransform:"uppercase",marginBottom:18}}>Agenda · Seguimiento</div>

          {[
            {label:L.eventTitle,key:"title",type:"text",ph:"Ej: Llamada con cliente"},
            {label:L.eventDate,key:"date",type:"date",ph:""},
            {label:L.eventTime,key:"time",type:"time",ph:""},
          ].map(f=>(
            <div key={f.key} style={{marginBottom:12}}>
              ...
              <input type={f.type} value={eventForm[f.key]} onChange={e=>setEventForm(ef=>({...ef,[f.key]:e.target.value}))} placeholder={f.ph}
                style={{width:"100%",maxWidth:"100%",display:"block",background:T.card,border:`1px solid ${T.border}`,borderRadius:2,padding:"9px 12px",color:T.text,fontSize:13,fontFamily:"'Jost',sans-serif"}}/>
            </div>
          ))}
          ...
          <div style={{marginBottom:18}}>
            ...
            <textarea value={eventForm.notes||""} onChange={e=>setEventForm(ef=>({...ef,notes:e.target.value}))} placeholder={lang==="en"?"Event details...":"Detalles del evento..."} rows={2}
          ...
          <div style={{display:"flex",gap:8}}>
            ...
            <button className="pBtn" onClick={()=>setShowEventForm(false)} style={{flex:1,background:T.card,border:`1px solid ${T.border}`,color:T.textMuted,padding:"10px",borderRadius:2,fontSize:11}}>{L.cancel}</button>
            <button className="pBtn" onClick={()=>{
              ...
              else{setEvents([...events,{...eventForm,id:Date.now()}]);showN("◈ Evento agregado");}
              ...
              {editingEvent?"Guardar":L.addEvent}
            </button>
          </div>
        </div>
      </div>
    ...
    {showSettings&&(
      <div style={{position:"fixed",inset:0,background:"rgba(44,36,32,.6)",zIndex:300,display:"flex",alignItems:"center",justifyContent:"center",padding:16,animation:"fadeIn .2s"}} onClick={()=>setShowSettings(false)}>
        <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,width:520,maxHeight:"88vh",display:"flex",flexDirection:"column",animation:"fadeUp .25s"}} onClick={e=>e.stopPropagation()}>
          ...
          <div style={{display:"flex",borderBottom:`1px solid ${T.border}`,flexShrink:0}}>
            {[["perfil",L.profileTab],["etapas",L.stagesTab],["categoria",L.categoryTab],["apariencia",L.appearanceTab],["idioma",L.languageTab]].map(([id,label])=>(
          ...
          <div style={{flex:1,overflowY:"auto",padding:"18px 22px"}}>
            ...
            {settTab==="perfil"&&(
              <div>
                <div style={{marginBottom:14}}>
                  <div style={{fontSize:9,color:T.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:5,fontWeight:600}}>{L.yourName}</div>
                  <input value={settName} onChange={e=>setSettName(e.target.value)} placeholder={lang==="en"?"Your full name":"Tu nombre completo"}
                ...
                <div style={{marginBottom:22}}>
                  <div style={{fontSize:9,color:T.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:5,fontWeight:600}}>{L.businessName}</div>
            ...
            {settTab==="etapas"&&(
              <div>
                <p style={{fontSize:12,color:T.textMuted,marginBottom:14,lineHeight:1.6}}>{L.stagesDesc}</p>
            ...
            {settTab==="categoria"&&(
              <div>
                <p style={{fontSize:12,color:T.textMuted,marginBottom:14,lineHeight:1.6}}>{L.categoryDesc}</p>
            ...
            {settTab==="apariencia"&&(
              <div>
                <p style={{fontSize:12,color:T.textMuted,marginBottom:20,lineHeight:1.6}}>{L.appearanceDesc}</p>
                <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,width:"100%",minWidth:0}}>
                    ...
                    return(
                      <button key={theme.id} className="pBtn" onClick={async()=>{
                        ...
                        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
                          <span style={{fontSize:12,fontWeight:600,color:theme.text,fontFamily:"'Jost',sans-serif"}}>{typeof theme.name==="object"?theme.name[lang||"es"]:theme.name}</span>
            ...
            {settTab==="idioma"&&(
              <div>
                <p style={{fontSize:12,color:T.textMuted,marginBottom:20,lineHeight:1.6}}>{L.languageDesc}</p>
    ...
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center",padding:24,fontFamily:"'Jost',sans-serif"}}>
      <div className="fadeUp" style={{width:"100%",maxWidth:400}}>
        ...
        <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,padding:28}}>
          <div style={{fontSize:9,color:T.gold,letterSpacing:2,textTransform:"uppercase",marginBottom:4}}>{mode==="signup"?L.signUp:mode==="forgot"?L.forgotPassword:L.signIn}</div>
          ...
          <button className="pBtn" onClick={mode==="forgot"?handleForgot:handleSubmit} disabled={loading}
            ...
            {loading?"Procesando...":(mode==="signup"?L.signUp:mode==="forgot"?"Enviar enlace":"Entrar")}
          </button>
...
export default function App(){
  ...
  const [lang,setLang]=useState(()=>localStorage.getItem("bobul_lang")||"es");
  ...
  const loadProfile=async(userId)=>{
    ...
    if(data?.stages){
      ...
      if(data.lang){
        setLang(data.lang);
        localStorage.setItem("bobul_lang",data.lang);
      }
    }
  ...
  if(user===undefined||loadingConfig) return(
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Cormorant Garamond',serif"}}>
      <div style={{textAlign:"center"}}>
        ...
        <div style={{fontSize:14,color:T.textMuted,letterSpacing:2}}>{lang==="en"?"Loading Bobul...":"Cargando Bobul..."}</div>
      </div>
    </div>
  );

  // Not authenticated
  if(!user) return(<><style>{css}</style><AuthScreen onAuth={handleAuth} lang={lang}/></>);
  ...
  // Full CRM
  return(<><style>{css}</style><CRM config={config} user={user} supabase={sb} plan={plan} themeId={themeId} onThemeChange={async(id)=>{setThemeId(id);Object.assign(T,THEMES[id]||THEMES.ivory);localStorage.setItem("bobul_theme",id);if(sb&&user)await sb.from("profiles").update({theme:id}).eq("id",user.id);}} lang={lang} onLangChange={async(l)=>{setLang(l);localStorage.setItem("bobul_lang",l);if(sb&&user)await sb.from("profiles").update({lang:l}).eq("id",user.id);}} onUpgrade={()=>setShowPricing(true)} onReset={(newCfg)=>{ if(newCfg&&typeof newCfg==="object") setConfig({...newCfg}); else setConfig(null); }} onSignOut={handleSignOut}/></>);
}
