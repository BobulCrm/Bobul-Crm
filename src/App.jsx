    ...
    <div style={{background:T.surface,borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:100}}>
      ...
      <div style={{padding:"0 12px",display:"flex",alignItems:"center",height:50,gap:8}}>
        ...
        <div style={{display:"flex",alignItems:"center",gap:6}}>
          <button className="pBtn" onClick={()=>{setShowSearch(s=>!s);if(showSearch)setSearch("");}} title="Filtrar lista" style={{background:showSearch?`${T.gold}15`:"transparent",border:`1px solid ${T.border}`,borderRadius:2,padding:"0 10px",fontSize:14,color:showSearch?T.gold:T.textMuted,flexShrink:0,height:32,display:"flex",alignItems:"center"}}>🔍</button>

          <button className="pBtn" onClick={()=>{setGlobalSearchOpen(true);setGlobalSearchQuery("");}} title="Búsqueda global" style={{background:"transparent",border:`1px solid ${T.border}`,borderRadius:2,padding:"0 10px",fontSize:14,color:T.textMuted,flexShrink:0,height:32,display:"flex",alignItems:"center"}}>⌕</button>
        ...
        <div style={{position:"fixed",inset:0,background:"rgba(0,0,0,.45)",zIndex:600,display:"flex",alignItems:"flex-start",justifyContent:"center",padding:"60px 16px 16px"}} onClick={()=>setGlobalSearchOpen(false)}>
          <div style={{background:T.surface,border:`1px solid ${T.border}`,borderRadius:3,maxWidth:560,width:"100%",maxHeight:"80vh",display:"flex",flexDirection:"column"}} onClick={e=>e.stopPropagation()}>
            ...
            <div style={{padding:"12px 14px",borderBottom:`1px solid ${T.border}`,display:"flex",alignItems:"center",gap:10}}>
              ...
              />
              <button onClick={()=>setGlobalSearchOpen(false)} style={{background:"transparent",border:"none",color:T.textMuted,fontSize:14,cursor:"pointer",padding:"4px 8px"}}>esc</button>
            </div>
            ...
            {q && totalResults > 0 && (
              <div style={{padding:"8px 16px",borderTop:`1px solid ${T.border}`,fontSize:10,color:T.textDim,textAlign:"center"}}>
                {totalResults === 1 ? "Enter para abrir · " : ""}Esc para cerrar
              </div>
            )}
          </div>
        </div>
