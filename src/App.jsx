    ...
    <div style={{background:T.surface,borderBottom:`1px solid ${T.border}`,position:"sticky",top:0,zIndex:100}}>
      ...
      <div style={{padding:"0 12px",display:"flex",alignItems:"center",height:50,gap:8}}>
        <div style={{display:"flex",alignItems:"center",gap:7,flexShrink:0,position:"relative"}}>
          ...
          <div style={{cursor:"pointer"}} onClick={e=>{e.stopPropagation();setShowCategoryTip(v=>!v);}}>
          ...
          {showCategoryTip&&(
            <div onClick={e=>e.stopPropagation()} style={{position:"fixed",top:56,left:12,background:T.surface,border:`1px solid ${T.border}`,borderRadius:2,padding:"12px 16px",zIndex:500,boxShadow:"0 4px 24px rgba(0,0,0,.18)",minWidth:200,animation:"fadeUp .15s"}}>
              <div style={{fontSize:9,color:T.gold,letterSpacing:1.5,textTransform:"uppercase",marginBottom:4}}>Negocio</div>
              <div style={{fontSize:14,fontWeight:600,color:T.text,fontFamily:"Cormorant Garamond,serif",marginBottom:10}}>{company||name}</div>
